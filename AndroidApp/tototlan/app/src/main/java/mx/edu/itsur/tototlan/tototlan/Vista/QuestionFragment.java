...
import mx.edu.itsur.tototlan.tototlan.modelo.OpenQuestionM;
...
public abstract class QuestionFragment extends Fragment {
    ...
    public static class QuestionFragmentBuilder {
        ...
        public QuestionFragment build() {
           ...
           QuestionFragment questionFragment = mx.edu.itsur.tototlan.tototlan.Vista.OpenQuestion.newInstance(question,answer);
